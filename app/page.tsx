...
<section
  ...
  className={`py-16 bg-white relative ${
    visibleSections.has("founders") ? "animate-slide-up" : "opacity-0"
  }`}
>
  <div className="container mx-auto px-4">
    <div className="text-center mb-12">
      <h2 className="text-3xl md:text-4xl font-bold text-econova-primary mb-2">
        Founders
      </h2>
      <p className="text-lg text-econova-text-light">
        The team behind EcoNova
      </p>
    </div>
    ...
    <div className="flex flex-col sm:flex-row justify-center gap-6 max-w-2xl mx-auto">
      {[
        ...
        >
          <div className="mb-2">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-econova-primary to-econova-secondary flex items-center justify-center text-white text-xl font-bold mx-auto">
              {founder.name.split(' ').map(n => n[0]).join('')}
            </div>
          </div>
          <h3 className="font-medium text-econova-primary">{founder.name}</h3>
          <p className="text-sm text-econova-text-light mb-2">{founder.title}</p>
          <Link href={founder.linkedin} target="_blank" rel="noopener noreferrer">
            <Button variant="ghost" size="sm" className="text-econova-primary hover:text-econova-secondary p-0 h-auto">
